...
int main(int argc, char** argv)
{
	...
	twist_msg_neg.linear.x=-0.25;
	twist_msg_neg.linear.y=0;
	twist_msg_neg.linear.z=0;
	twist_msg_neg.angular.x=0;
	twist_msg_neg.angular.y=0;
	twist_msg_neg.angular.z=0;
