...
if("FALSE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/edrone/catkin_ws/src/control)
  set(control_DEVEL_PREFIX /home/edrone/catkin_ws/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/edrone/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'edrone <edrone@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edrone/catkin_ws/install/${idir}'.  Ask the maintainer 'edrone <edrone@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${control_dep}_FOUND)
      find_package(${control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${control_dep} REQUIRED ${depend_list})
  endif()
